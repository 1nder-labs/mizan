...
CREATE UNIQUE INDEX `member_user_org_uniq` ON `member` (`user_id`,`organization_id`);--> statement-breakpoint
...
ALTER TABLE `briefs` ADD `organization_id` text NOT NULL REFERENCES organization(id);--> statement-breakpoint
...
ALTER TABLE `cases` ADD `organization_id` text NOT NULL REFERENCES organization(id);--> statement-breakpoint
...
ALTER TABLE `reviewer_actions` ADD `organization_id` text NOT NULL REFERENCES organization(id);--> statement-breakpoint
CREATE INDEX `reviewer_actions_org_case_id_idx` ON `reviewer_actions` (`organization_id`,`case_id`);--> statement-breakpoint
ALTER TABLE `signals` ADD `organization_id` text NOT NULL REFERENCES organization(id);--> statement-breakpoint
CREATE INDEX `signals_org_case_id_idx` ON `signals` (`organization_id`,`case_id`);--> statement-breakpoint
ALTER TABLE `workflow_events` ADD `organization_id` text NOT NULL REFERENCES organization(id);--> statement-breakpoint
CREATE INDEX `workflow_events_org_case_id_idx` ON `workflow_events` (`organization_id`,`case_id`);--> statement-breakpoint
ALTER TABLE `sessions` ADD `active_organization_id` text REFERENCES organization(id);--> statement-breakpoint
