  ...
  return (
    <div className="flex h-full flex-col justify-center gap-5 px-5 py-10">
      <div className="space-y-3">
        ...
        <h2 className="text-base font-semibold tracking-[-0.01em] leading-snug text-foreground">
      ...
      <div className="flex flex-col gap-1.5">
        {prompts.map((prompt) => (
          <Button
            ...
            variant="outline"
            className={[
              "h-auto justify-start whitespace-normal px-3 py-2.5 text-left text-xs",
              "font-normal text-foreground/80 transition-colors hover:border-border hover:text-foreground",
            ].join(" ")}
